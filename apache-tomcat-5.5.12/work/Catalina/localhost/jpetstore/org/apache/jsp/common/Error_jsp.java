...
public final class Error_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/common/../common/IncludeTop.jsp");
    _jspx_dependants.add("/WEB-INF/tld/struts-logic.tld");
    _jspx_dependants.add("/WEB-INF/tld/struts-bean.tld");
    _jspx_dependants.add("/WEB-INF/tld/struts-html.tld");
    _jspx_dependants.add("/common/../common/../common/IncludeQuickHeader.jsp");
    _jspx_dependants.add("/common/../common/IncludeBottom.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_logic_present_5.setName("BeanActionException");
  ...
  private boolean _jspx_meth_logic_notPresent_1(PageContext _jspx_page_context)
    ...
    _jspx_th_logic_notPresent_1.setName("BeanActionException");
    ...
    if (_jspx_eval_logic_notPresent_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("  ");
        if (_jspx_meth_logic_notPresent_2(_jspx_th_logic_notPresent_1, _jspx_page_context))
          return true;
        out.write('\r');
        out.write('\n');
  ...
  private boolean _jspx_meth_logic_notPresent_2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_notPresent_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  logic:notPresent
    ...
    _jspx_th_logic_notPresent_2.setPageContext(_jspx_page_context);
    _jspx_th_logic_notPresent_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_notPresent_1);
    _jspx_th_logic_notPresent_2.setName("message");
    ...
    if (_jspx_eval_logic_notPresent_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("    <H3>Something happened...</H3>\r\n");
        out.write("    <B>But no further information was provided.</B>\r\n");
        out.write("  ");
  ...
  private boolean _jspx_meth_logic_present_4(PageContext _jspx_page_context)
    ...
    _jspx_th_logic_present_4.setName("BeanActionException");
    ...
    if (_jspx_eval_logic_present_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("  <B><font color=\"red\">");
        if (_jspx_meth_bean_write_2(_jspx_th_logic_present_4, _jspx_page_context))
          return true;
        out.write("</font></B>\r\n");
        out.write("  <P/>\r\n");
        out.write("  ");
        if (_jspx_meth_bean_write_3(_jspx_th_logic_present_4, _jspx_page_context))
          return true;
        out.write('\r');
        out.write('\n');
  ...
  private boolean _jspx_meth_bean_write_2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_present_4, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_2.setName("BeanActionException");
    _jspx_th_bean_write_2.setProperty("class.name");
  ...
  private boolean _jspx_meth_bean_write_3(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_present_4, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_3.setName("BeanActionException");
    _jspx_th_bean_write_3.setProperty("message");
